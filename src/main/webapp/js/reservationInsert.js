...
const qty = document.querySelector("#rentQty") 
...
rentEday.addEventListener("input", () => {
	...
	document.querySelector("#ddayCalc").innerText = `${diff}일`
	document.querySelector("#rentDday").value = diff
	calcTotalPrice();
})
...
function calcTotalPrice(){
	let cnt = document.querySelector("#rentQty").value;
